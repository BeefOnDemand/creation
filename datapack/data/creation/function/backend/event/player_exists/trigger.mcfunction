...
execute unless score @s cr.dpack.Updated = [Creation] cr.dpack.Updated if score @s cr.dpack.Installed matches 1 run scoreboard players set @s cr.check.ConditionsPassed 1
